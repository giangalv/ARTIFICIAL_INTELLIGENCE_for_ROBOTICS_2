...
(define (problem caffe_bar_problem_2)
    ...
    (:init
        ...
        (drink-info c1 d1 t3) (drink-info c2 d2 t3) (drink-info c3 d3 t3) (drink-info c4 d4 t3)
        (biscuit-info c3 u1 t3) (biscuit-info c4 u2 t3)
        (biscuit-info c3 u1 bar) (biscuit-info c4 u2 bar)
